...
export default function Priorities() {
    ...
    return (
        <>
            ...
            <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }} sx={{ padding: '5rem 3rem', backgroundImage: "url('/assets/img/bggg.png')", backgroundAttachment: 'fixed', backgroundSize: '100%' }}>
